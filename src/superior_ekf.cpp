...
SuperiorEKF::SuperiorEKF(ConfigParser config) {
...
cv::Mat SuperiorEKF::correct(cv::Mat measurement) {
...
/*Mat SuperiorEKF::getMeasurement() {

}

Mat SuperiorEKF::getMJacobian() {
